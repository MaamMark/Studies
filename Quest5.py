# Faça um programa que o usuário entre com os valores de notas de um aluno de acordo com a tabela a seguir e no final possa apresentar a média final do aluno.
# Nota 1 = Prova 1 + Lista 1
# Nota 2 = Prova 2 + Lista 2
# Média final = (Nota 1 + Nota 2) / 2

# Variáveis que recebem os valores que indicam as notas do aluno
...
print(f"A nota final deste aluno é {mf}")